...
/*
    ...
    Registra un snapshot inmutable de una exportaci�n de Punches.

    Identificadores:
    - PunchExportLogId: bigint procedente del proceso de exportaci�n.
    - ExportBatchId: uniqueidentifier t�cnico del snapshot.
...
/* ==========================================================================
   1. REGISTRAR SNAPSHOT DE EXPORTACI�N
   ========================================================================== */
...
BEGIN
    ...
    BEGIN TRY
        ...
        /* ------------------------------------------------------------------
           ...
           errores funcionales controlados en vez de errores de inserci�n.
           ------------------------------------------------------------------ */
...
/* ==========================================================================
   2. COMPLETAR SNAPSHOT DE EXPORTACI�N
   ========================================================================== */
...
BEGIN
    ...
    BEGIN TRY
        ...
        /* ------------------------------------------------------------------
           2. Recuperar el ExportBatchId t�cnico
           ------------------------------------------------------------------ */
